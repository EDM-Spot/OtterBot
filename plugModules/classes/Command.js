...
const IMMEDIATE_DELETION = ['d', 'join', 'shush', 'rules', 'cmds', 'plays'];
const CMD_BANNED = ['cookie', 'myprops', 'xp', 'hello', 'catfact'];
...
module.exports = class Command {
	...
	async reply(string, variables = {}, ttl) {
		const reply = this.bot.plug.sendChat(this.utils.replace(this.lang.commands.default, {
	...
	async handleDeletion() {
		...
		this.deletionTimeout = setTimeout(async (rawData) => {
